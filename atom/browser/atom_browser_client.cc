...
void AtomBrowserClient::SetDisableProcessRestartTricks(bool should_disable) {
  disable_process_restart_tricks_ = should_disable;
}

bool AtomBrowserClient::ShouldDisableElectronProcessRestartTricks() {
...
void AtomBrowserClient::AppendExtraCommandLineSwitches(
  ...
  if (web_contents) {
    ...
    if (ShouldDisableElectronProcessRestartTricks()) {
